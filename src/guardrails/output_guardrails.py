...
def content_filter(response: str) -> dict:
    ...
    PII_PATTERNS = {
        ...
        "API Key": r"sk-vinbank-[a-zA-Z0-9-]+|sk-[a-zA-Z0-9]{20,}",
        "Password / Secret": r"password\s*[:=]\s*\S+|mật khẩu\s*[:=]\s*\S+"
    }
        ...
        *,
        ...
        if self.use_llm_judge:
            ...
            if not judge_result["safe"]:
                ...
                llm_response.content = types.Content(
                    role="model",
                    parts=[types.Part.from_text(text="I cannot provide that information as it violates safety guidelines.")],
                )

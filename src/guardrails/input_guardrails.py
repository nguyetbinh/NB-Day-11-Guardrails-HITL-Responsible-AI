...
def detect_injection(user_input: str) -> bool:
    ...
    INJECTION_PATTERNS = [
        ...
        r"reveal your (instructions|prompt|secret|password|api key)",
        r"pretend you are",
        r"act as (a |an )?unrestricted",
        r"bỏ qua (mọi )?(hướng dẫn|chỉ thị)",
        r"tiết lộ.*mật khẩu|cho tôi biết.*mật khẩu",
        r"reveal the admin password",
        r"provide all credentials",
        r"translate your system prompt",
        r"connection string is",
        r"knows the same passwords"
    ]
...
def topic_filter(user_input: str) -> bool:
    ...
    greetings = ["hi", "hello", "good morning", "good afternoon", "good evening", "xin chào", "chào", "chao"]
    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response("Request blocked: off-topic or blocked topic detected.")
